...
<html lang="en">
<head>
    <title>OFRS | Teams En Route</title>
    ...
    <style>
        ...
        .status-pill { padding: 5px 12px; border-radius: 20px; font-size: 11px; font-weight: bold; background: rgba(255,200,87,0.2); color: var(--orange); text-transform: uppercase; }
...
<body>
    ...
    <div class="main">
        <h1 style="font-family:'Orbitron'; color: #ffc857;">Teams En Route</h1>
        <table class="glass-table">
            <thead><tr><th>#</th><th>Reporter</th><th>Team</th><th>Location</th><th>Status</th><th>Action</th></tr></thead>
            <tbody>
                <?php 
                $query=mysqli_query($con,"select * from tblfirereport where status='Team On the Way'");
                $cnt=1;
                ...
                <tr>
                    ...
                    <td><span class="status-pill">En Route</span></td>
                    <td><a href="request-details.php?requestid=<?php echo $row['id'];?>" class="btn-view">Monitor</a></td>
                </tr>
                <?php $cnt++; } ?>
            </tbody>
        </table>
